...
import { ApiCreateIndustry, ApiDeleteIndustry, ApiFindAllIndustries, ApiFindIndustryById, ApiUpdateIndustry } from '../docs/industry.docs';
...
import { AdminIndustryService } from '../services/industry.service';

@ApiTags('Admin - Industries')
@ApiBearerAuth()
@Controller('industries')
export class AdminIndustryController {
  private readonly logger = new Logger(AdminIndustryController.name);

  constructor(private readonly industryService: AdminIndustryService) {}
