...
CREATE INDEX "email_change_requests_revert_token_idx" ON "cloud"."email_change_requests" ("revert_token");--> statement-breakpoint
CREATE INDEX "phone_change_requests_user_id_idx" ON "cloud"."phone_change_requests" ("user_id");--> statement-breakpoint
CREATE INDEX "phone_change_requests_revert_token_idx" ON "cloud"."phone_change_requests" ("revert_token");--> statement-breakpoint
...
ALTER TABLE "cloud"."email_change_requests" ADD CONSTRAINT "email_change_requests_sb1CcOZGzeg9_fkey" FOREIGN KEY ("identity_verification_id") REFERENCES "cloud"."email_verifications"("id");--> statement-breakpoint
ALTER TABLE "cloud"."email_change_requests" ADD CONSTRAINT "email_change_requests_spyNFvaMwkQE_fkey" FOREIGN KEY ("new_email_verification_id") REFERENCES "cloud"."email_verifications"("id");--> statement-breakpoint
...
ALTER TABLE "cloud"."phone_change_requests" ADD CONSTRAINT "phone_change_requests_AwRcQcnhe64P_fkey" FOREIGN KEY ("identity_verification_id") REFERENCES "cloud"."mobile_verifications"("id");--> statement-breakpoint
ALTER TABLE "cloud"."phone_change_requests" ADD CONSTRAINT "phone_change_requests_eW9xEDzbTZB2_fkey" FOREIGN KEY ("new_phone_verification_id") REFERENCES "cloud"."mobile_verifications"("id");